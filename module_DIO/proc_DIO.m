function nwb = proc_DIO(pp, nwb, recdev)
...
for mm = 1 : numel(recdev.dio_map)
    ...
    elseif strcmp(recdev.dio_map{mm}.description, 'aggregated')

        load([pp.CAT_DATA nwb.identifier '_dev-' num2str(recdev.num) filesep ...
            'board-DIGITAL-IN-aggregated.mat']);

        event_data{1}.task = [erase(nwb.general_experiment_description(1:end-1), " ") ...
            '_dev_' num2str(recdev.num)];
        event_data{1}.codes = event_codes;
