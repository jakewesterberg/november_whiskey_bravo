function proc_BIN(pp, nwb, recdev, probe, car_bin, method_version)
...
switch method_version
    ...
    case 2
        if ~exist([pp.REPO 'module_BIN\quickened_binarization.mexw64'], 'file');
            mex_path = [pp.REPO 'module_BIN\quickened_binarization.cpp'];
            mex mex_path
        end

        quickened_binarization( ...
            NUM_CHANNELS, ...
            num_samples, ...
            char(fullfile(in_file_path)), ...
            port_letter, ...
            char(fullfile(file_name)));
