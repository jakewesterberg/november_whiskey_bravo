...
properties
    ...
    features; % REQUIRED ((float32) ) Multi-dimensional array of features extracted from each event.
    times; % REQUIRED ((float64) ) Times of events that features correspond to (can be a link).
end
