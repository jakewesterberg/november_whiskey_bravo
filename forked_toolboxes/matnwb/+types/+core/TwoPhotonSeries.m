...
% OPTIONAL PROPERTIES
properties
    field_of_view; % OPTIONAL ((float32) ) Width, height and depth of image, or imaged area, in meters.
    pmt_gain; % OPTIONAL (float32) Photomultiplier gain.
    scan_line_rate; % OPTIONAL (float32) Lines imaged per second. This is also stored in /general/optophysiology but is kept here as it is useful information for analysis, and so good to be stored w/ the actual data.
end
