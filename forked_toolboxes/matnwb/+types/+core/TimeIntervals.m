...
% OPTIONAL PROPERTIES
properties
    tags; % OPTIONAL (VectorData) User-defined tags that identify or categorize events.
    tags_index; % OPTIONAL (VectorIndex) Index for tags.
    timeseries; % OPTIONAL (VectorData) An index into a TimeSeries object.
    timeseries_index; % OPTIONAL (VectorIndex) Index for timeseries.
end
