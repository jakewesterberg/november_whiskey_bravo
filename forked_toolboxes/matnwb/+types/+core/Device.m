...
% OPTIONAL PROPERTIES
properties
    description; % OPTIONAL (char) Description of the device (e.g., model, firmware version, processing software version, etc.) as free-form text.
    manufacturer; % OPTIONAL (char) The name of the manufacturer of the device.
end
