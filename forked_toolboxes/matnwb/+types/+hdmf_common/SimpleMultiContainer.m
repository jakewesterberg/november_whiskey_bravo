...
% OPTIONAL PROPERTIES
properties
    container; % OPTIONAL (Container) Container objects held within this SimpleMultiContainer.
    data; % OPTIONAL (Data) Data objects held within this SimpleMultiContainer.
end
